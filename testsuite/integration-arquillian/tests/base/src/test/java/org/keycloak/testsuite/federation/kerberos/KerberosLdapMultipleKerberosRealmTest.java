...
public class KerberosLdapMultipleKerberosRealmTest extends AbstractKerberosTest {

    private static final String PROVIDER_CONFIG_GROUPA_LOCATION = "classpath:kerberos/kerberos-groupA-ldap-connection.properties";
    private static final String PROVIDER_CONFIG_GROUPB_LOCATION = "classpath:kerberos/kerberos-groupA-ldap-connection.properties";
    private static final String PROVIDER_CONFIG_ALTERNATIVE_LOCATION = "classpath:kerberos/kerberos-alternative-ldap-connection.properties";

    @ClassRule
    public static KerberosRule kerberosRuleGroupA = new KerberosRule(PROVIDER_CONFIG_GROUPA_LOCATION, KerberosEmbeddedServer.DEFAULT_KERBEROS_REALM);

    @ClassRule
    public static KerberosRule kerberosRuleGroupB = new KerberosRule(PROVIDER_CONFIG_GROUPA_LOCATION, KerberosEmbeddedServer.DEFAULT_KERBEROS_REALM);

    @ClassRule
    public static KerberosRule kerberosRuleAlternate = new KerberosRule(PROVIDER_CONFIG_ALTERNATIVE_LOCATION, KerberosEmbeddedServer.DEFAULT_KERBEROS_REALM_2);
